...
2. Refactor your code so that it can accept data in other formats if necessary. You can use the [Adapter pattern](https://refactoring.guru/design-patterns/adapter) for this, but you can also use a different one if you prefer.
